	...
	<form id="mainForm"  method="post">
		...
		<table align="center" class="edittable">
			<tr>
				...
				<td width="35%"><input type="text"  id="label" name="label" value="${dict.label}" class="easyui-validatebox input_bg" maxlength="80" data-options="required:true,validType:['unique[\'${ctxAdmin}/shoes/dict/checkLabel?id=${dict.id}\',\'label\',\'1\',\'该类型的标签已存在\',\'type\']']" /></td>
			</tr>
			<tr>	
				<td width="15%">值：<span class="safari-required">*</span></td>
				<td width="35%"><input type="text" id="value" name="value"  value="${dict.value}" class="easyui-validatebox input_bg" maxlength="80" data-options="required:true"/></td>
				<td width="15%">排序：</td>
				<td width="35%"><input type="text" id="sort" name="sort"  value="${dict.sort}" class="easyui-validatebox input_bg" maxlength="10" data-options="validType:['number']" /></td>
			</tr>
			<tr>
				<td width="15%">是否可用：</td>
				<td  width="35%">
   		...
   		success:function(result){
			if (result == "success"){
			    $.messager.alert("提示","保存成功","info",function(){
					top.closeDlg("dlgb");
				    $("#btn_save").removeAttr("disabled");
				    reloadDatagrid("shoes/dict", "#mainTable");
				});
			} else {
