package org.safari.platform.common.security.shiro.cache;
...
public class SessionCacheManager implements CacheManager {
	...
	public class SessionCache<K, V> implements Cache<K, V> {
		...
		public V get(K key) throws CacheException {
			...
			LOG.debug("get {} {} {}", cacheKeyName, key, request != null ? request.getRequestURI() : "");
		...
		public V put(K key, V value) throws CacheException {
			...
			if (LOG.isDebugEnabled()){
				HttpServletRequest request = ServletUtil.getRequest();
				LOG.debug("put {} {} {}", cacheKeyName, key, request != null ? request.getRequestURI() : "");
			}
